...
const categoriesData = [
  {
    ...
    code: "BEV",
    description:
      "Packaged juices, premium mineral waters, sodas, and roasted coffee blends",
  },
  {
    name: "Fresh Produce & Greens",
    code: "PRO",
    description:
      "Locally sourced organic fruits, root vegetables, and fresh greens",
  },
  {
    name: "Bakery & Confectionery",
    code: "BAK",
    description:
      "Daily baked artisanal bread, rolls, breakfast pastries, and flour mixes",
  },
  {
  ...
  },
  {
    ...
    code: "PER",
    description:
      "Daily essentials, hygiene products, soaps, dental and hair care",
  },
];
...
const productsData = [
  // Beverages (9 items)
  {
    name: "Highland Spring Water 500ml",
    catCode: "BEV",
    unit: "btl",
    costPrice: 15.0,
    sellingPrice: 25.0,
  ...
  {
    name: "Harar Dark Roast Ground Coffee 500g",
    catCode: "BEV",
    unit: "pkg",
    costPrice: 320.0,
    sellingPrice: 450.0,
  ...
  {
    name: "Yirgacheffe Arabica Beans 250g",
    catCode: "BEV",
    unit: "pkg",
    costPrice: 280.0,
    sellingPrice: 400.0,
  ...
  {
    name: "Sparkling Lemon Flavored Soda 330ml",
    catCode: "BEV",
    unit: "can",
    costPrice: 25.0,
    sellingPrice: 45.0,
  ...
  // Bakery (9 items)
  {
    name: "Whole Grain Sliced Bread 800g",
    catCode: "BAK",
    unit: "loaf",
    costPrice: 45.0,
    sellingPrice: 70.0,
  ...
  {
    name: "Artisanal Sourdough Bread 600g",
    catCode: "BAK",
    unit: "loaf",
    costPrice: 65.0,
    sellingPrice: 110.0,
  ...
  {
    name: "Soft White Toast Bread 600g",
    catCode: "BAK",
    unit: "loaf",
    costPrice: 38.0,
    sellingPrice: 60.0,
  ...
  {
    name: "Chocolate Swirl Muffins (Pack of 4)",
    catCode: "BAK",
    unit: "pkg",
    costPrice: 120.0,
    sellingPrice: 190.0,
  ...
  {
    name: "Brioche Burger Buns (Pack of 6)",
    catCode: "BAK",
    unit: "pkg",
    costPrice: 85.0,
    sellingPrice: 135.0,
  ...
  {
    name: "Self-Rising Cake Flour 1kg",
    catCode: "BAK",
    unit: "bag",
    costPrice: 85.0,
    sellingPrice: 130.0,
  ...
  {
    name: "Pure Refined Sunflower Oil 3L",
    catCode: "PAN",
    unit: "btl",
    costPrice: 420.0,
    sellingPrice: 590.0,
  ...
  {
    name: "Durum Penne Rigate Pasta 500g",
    catCode: "PAN",
    unit: "pkg",
    costPrice: 55.0,
    sellingPrice: 90.0,
  ...
  {
    name: "Peeled Plum Canned Tomatoes 400g",
    catCode: "PAN",
    unit: "can",
    costPrice: 60.0,
    sellingPrice: 95.0,
  ...
  {
    name: "Canned Red Kidney Beans 400g",
    catCode: "PAN",
    unit: "can",
    costPrice: 50.0,
    sellingPrice: 80.0,
  ...
  {
    name: "Pure Cane Sugar Granulated 2kg",
    catCode: "PAN",
    unit: "bag",
    costPrice: 170.0,
    sellingPrice: 240.0,
  ...
  // Dairy (8 items)
  {
    name: "Pasteurized Fresh Whole Milk 1L",
    catCode: "DAI",
    unit: "ctn",
    costPrice: 65.0,
    sellingPrice: 95.0,
  ...
  {
    name: "Farm Fresh Large Brown Eggs (30-Pack)",
    catCode: "DAI",
    unit: "crt",
    costPrice: 280.0,
    sellingPrice: 380.0,
  ...
  {
    name: "Unsalted Creamery Butter 250g",
    catCode: "DAI",
    unit: "blk",
    costPrice: 160.0,
    sellingPrice: 230.0,
  ...
  {
    name: "Aged Mild Cheddar Cheese Block 400g",
    catCode: "DAI",
    unit: "blk",
    costPrice: 310.0,
    sellingPrice: 440.0,
  ...
  {
    name: "Natural Greek Yogurt Plain 500g",
    catCode: "DAI",
    unit: "tub",
    costPrice: 115.0,
    sellingPrice: 175.0,
  ...
  {
    name: "Strawberry Flavored Yogurt 200ml",
    catCode: "DAI",
    unit: "cup",
    costPrice: 40.0,
    sellingPrice: 65.0,
  ...
  {
    name: "Whipped Cream Spray 250ml",
    catCode: "DAI",
    unit: "can",
    costPrice: 190.0,
    sellingPrice: 280.0,
  ...
  {
    name: "Fresh Mozzarella Ball 200g",
    catCode: "DAI",
    unit: "pkg",
    costPrice: 175.0,
    sellingPrice: 260.0,
  ...
  {
    name: "Antibacterial Liquid Hand Soap 500ml",
    catCode: "PER",
    unit: "btl",
    costPrice: 90.0,
    sellingPrice: 145.0,
  ...
  {
    name: "Nourishing Herbal Shampoo 400ml",
    catCode: "PER",
    unit: "btl",
    costPrice: 160.0,
    sellingPrice: 240.0,
  ...
  {
    name: "Moisturizing Hair Conditioner 400ml",
    catCode: "PER",
    unit: "btl",
    costPrice: 170.0,
    sellingPrice: 250.0,
  ...
  {
    name: "Fluoride Protection Toothpaste 100ml",
    catCode: "PER",
    unit: "tub",
    costPrice: 75.0,
    sellingPrice: 120.0,
  ...
  {
    name: "Medium Bristle Toothbrush 2-Pack",
    catCode: "PER",
    unit: "pkg",
    costPrice: 60.0,
    sellingPrice: 95.0,
  ...
  {
    name: "Soft Facial Tissues (200 sheets)",
    catCode: "PER",
    unit: "box",
    costPrice: 50.0,
    sellingPrice: 85.0,
  ...
  {
    name: "Premium 3-Ply Toilet Paper (10 Rolls)",
    catCode: "PER",
    unit: "pkg",
    costPrice: 220.0,
    sellingPrice: 330.0,
...
const customersData = [
  ...
  },
  {
    ...
    notes:
      "Corporate accounts for hotel breakfast bar items and personal care supplies",
  },
  {
...
const main = async () => {
  ...
  await prisma.$transaction(
    async (tx) => {
      ...
      console.log(
        "✓ Initial stock inventory and threshold alerts established.",
      );
      ...
      const createPurchase = async (
        ...
        const calculatedTotal = items.reduce(
          (sum, it) => sum + lineTotal(it.quantity, it.unitCost),
          0,
        );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[0].id, quantity: 150, unitCost: 15.0 },
          { productId: productRows[1].id, quantity: 100, unitCost: 30.0 },
          { productId: productRows[2].id, quantity: 30, unitCost: 320.0 },
        ],
        28,
        "Monthly beverage restocking",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[9].id, quantity: 60, unitCost: 160.0 },
          { productId: productRows[10].id, quantity: 80, unitCost: 60.0 },
          { productId: productRows[12].id, quantity: 90, unitCost: 45.0 },
        ],
        24,
        "Bi-weekly organic produce procurement",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[18].id, quantity: 50, unitCost: 45.0 },
          { productId: productRows[19].id, quantity: 30, unitCost: 65.0 },
          { productId: productRows[21].id, quantity: 25, unitCost: 110.0 },
          { productId: productRows[25].id, quantity: 40, unitCost: 140.0 },
        ],
        20,
        "Bakery line replenishment",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[27].id, quantity: 30, unitCost: 580.0 },
          { productId: productRows[28].id, quantity: 40, unitCost: 420.0 },
          { productId: productRows[30].id, quantity: 80, unitCost: 55.0 },
        ],
        16,
        "Dry staples and cooking oils order",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[36].id, quantity: 90, unitCost: 65.0 },
          { productId: productRows[37].id, quantity: 35, unitCost: 280.0 },
          { productId: productRows[38].id, quantity: 25, unitCost: 160.0 },
        ],
        12,
        "Weekly fresh dairy crate intake",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[44].id, quantity: 40, unitCost: 90.0 },
          { productId: productRows[47].id, quantity: 50, unitCost: 75.0 },
          { productId: productRows[51].id, quantity: 30, unitCost: 220.0 },
        ],
        9,
        "Personal care wholesale shipment",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[5].id, quantity: 80, unitCost: 25.0 },
          { productId: productRows[6].id, quantity: 90, unitCost: 25.0 },
          { productId: productRows[7].id, quantity: 35, unitCost: 120.0 },
        ],
        5,
        "Weekend canned soft drinks refill",
      );
      ...
      await createPurchase(
        ...
        "COMPLETED",
        [
          { productId: productRows[13].id, quantity: 100, unitCost: 55.0 },
          { productId: productRows[14].id, quantity: 120, unitCost: 40.0 },
        ],
        2,
        "Root vegetables and onions shipment",
      );
      ...
      await createPurchase(
        ...
        "DRAFT",
        [
          { productId: productRows[39].id, quantity: 20, unitCost: 310.0 },
          { productId: productRows[40].id, quantity: 35, unitCost: 115.0 },
        ],
        1,
        "Pending dairy approval - cheddar and greek yogurt",
      );
      ...
      await createPurchase(
        ...
        supplierRows[3],
        "CANCELLED",
        [{ productId: productRows[29].id, quantity: 25, unitCost: 490.0 }],
        3,
        "Cancelled order due to supplier price discrepancy",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[2].id, quantity: 10, unitPrice: 450.0 },
          { productId: productRows[36].id, quantity: 30, unitPrice: 95.0 },
          { productId: productRows[35].id, quantity: 15, unitPrice: 240.0 },
        ],
        27,
        "Café Abyssinia weekly coffee and milk supply",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[25].id, quantity: 15, unitPrice: 210.0 },
          { productId: productRows[37].id, quantity: 8, unitPrice: 380.0 },
          { productId: productRows[38].id, quantity: 10, unitPrice: 230.0 },
        ],
        25,
        "Bethy Pastry baking supplies order",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[27].id, quantity: 6, unitPrice: 780.0 },
          { productId: productRows[28].id, quantity: 8, unitPrice: 590.0 },
          { productId: productRows[13].id, quantity: 25, unitPrice: 85.0 },
          { productId: productRows[14].id, quantity: 30, unitPrice: 65.0 },
        ],
        22,
        "Kebede Grill bulk restaurant procurement",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[0].id, quantity: 4, unitPrice: 25.0 },
          { productId: productRows[18].id, quantity: 1, unitPrice: 70.0 },
          { productId: productRows[9].id, quantity: 2, unitPrice: 230.0 },
          { productId: productRows[36].id, quantity: 2, unitPrice: 95.0 },
        ],
        19,
        "Walk-in basket checkout #1042",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[6].id, quantity: 35, unitPrice: 45.0 },
          { productId: productRows[5].id, quantity: 25, unitPrice: 45.0 },
          { productId: productRows[30].id, quantity: 20, unitPrice: 90.0 },
        ],
        17,
        "Corner grocer wholesale restock",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[2].id, quantity: 6, unitPrice: 450.0 },
          { productId: productRows[36].id, quantity: 25, unitPrice: 95.0 },
          { productId: productRows[21].id, quantity: 8, unitPrice: 175.0 },
          { productId: productRows[50].id, quantity: 10, unitPrice: 85.0 },
        ],
        14,
        "Capital Suites weekly hotel hospitality restock",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[0].id, quantity: 60, unitPrice: 25.0 },
          { productId: productRows[10].id, quantity: 15, unitPrice: 95.0 },
          { productId: productRows[40].id, quantity: 12, unitPrice: 175.0 },
        ],
        11,
        "FitLife Gym members refreshment counter",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[18].id, quantity: 2, unitPrice: 70.0 },
          { productId: productRows[28].id, quantity: 1, unitPrice: 590.0 },
          { productId: productRows[30].id, quantity: 3, unitPrice: 90.0 },
          { productId: productRows[44].id, quantity: 1, unitPrice: 145.0 },
        ],
        8,
        "Residential home groceries delivery",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[3].id, quantity: 4, unitPrice: 400.0 },
          { productId: productRows[4].id, quantity: 3, unitPrice: 140.0 },
          { productId: productRows[36].id, quantity: 15, unitPrice: 95.0 },
          { productId: productRows[51].id, quantity: 5, unitPrice: 330.0 },
        ],
        6,
        "TechCorp office pantry monthly restock",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[18].id, quantity: 8, unitPrice: 70.0 },
          { productId: productRows[36].id, quantity: 20, unitPrice: 95.0 },
          { productId: productRows[10].id, quantity: 12, unitPrice: 95.0 },
          { productId: productRows[44].id, quantity: 4, unitPrice: 145.0 },
        ],
        3,
        "Sunshine Daycare weekly order",
      );
      ...
      await createSale(
        ...
        "COMPLETED",
        [
          { productId: productRows[1].id, quantity: 3, unitPrice: 50.0 },
          { productId: productRows[7].id, quantity: 2, unitPrice: 180.0 },
          { productId: productRows[21].id, quantity: 1, unitPrice: 175.0 },
        ],
        1,
        "Counter walk-in evening purchase",
      );
      ...
      await createSale(
        ...
        "DRAFT",
        [
          { productId: productRows[27].id, quantity: 5, unitPrice: 780.0 },
          { productId: productRows[28].id, quantity: 4, unitPrice: 590.0 },
          { productId: productRows[37].id, quantity: 6, unitPrice: 380.0 },
        ],
        1,
        "Draft quote for Genet events weekend banquet",
      );
      ...
      await createSale(
        ...
        [
          { productId: productRows[18].id, quantity: 2, unitPrice: 70.0 },
          { productId: productRows[36].id, quantity: 4, unitPrice: 95.0 },
        ],
        0,
        "Cart checkout pending online payment confirmation",
      );
      ...
      await createSale(
        ...
        customerRows[3],
        "CANCELLED",
        [{ productId: productRows[29].id, quantity: 10, unitPrice: 690.0 }],
        5,
        "Customer cancelled - requested alternate brand",
      );
  ...
  console.log(
    `• Categories:    ${categoriesData.length} (BEV, PRO, BAK, PAN, DAI, PER)`,
  );
  console.log(
    `• Products:      ${productsData.length} active realistic items with pricing`,
  );
  console.log(
    `• Suppliers:     ${suppliersData.length} authentic business suppliers`,
  );
  console.log(
    `• Customers:     ${customersData.length} diverse real-world customers`,
  );
  console.log(
    "• Purchases:     10 transactions (8 Completed, 1 Draft, 1 Cancelled)",
  );
  console.log(
    "• Sales:         14 transactions (11 Completed, 2 Draft, 1 Cancelled)",
  );
